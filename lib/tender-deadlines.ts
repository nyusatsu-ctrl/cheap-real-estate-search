...
const DEADLINE_LABELS: Array<{ label: string; score: number; confidence: "high" | "medium"; kind: string; requiredContext?: RegExp }> = [
  ...
  { label: "資格・実績証明書等の提出期限", score: 390, confidence: "high", kind: "certificate_submission_deadline" },
  { label: "証明書等の提出期限", score: 388, confidence: "high", kind: "certificate_submission_deadline" },
  { label: "証明書等提出期限", score: 386, confidence: "high", kind: "certificate_submission_deadline" },
  ...
  { label: "見積書等の提出期限", score: 358, confidence: "high", kind: "quote_submission_deadline" },
  { label: "見積書等提出期限", score: 358, confidence: "high", kind: "quote_submission_deadline" },
