...
export const DIAGNOSIS_TYPES: Record<DiagnosisTypeCode, {
  ...
  A: {
    ...
    issue: "元請物件を受けるための見せ方、問い合わせ導線、見積基準が不足しています。",
  ...
  B: {
    code: "B",
    name: "協力業者拡大型",
    currentState: "既存物件をこなす力はありますが、受注量や対応範囲が協力先の数に左右されています。",
    ...
    action90Days: ["協力業者候補を10社以上確保する", "小規模物件で稼働テストを行う", "物件ごとの粗利と外注比率を確認する"]
  },
  C: {
    code: "C",
    name: "公共工事参入型",
    currentState: "民間工事中心から、安定した公共物件を検討できる土台があります。",
    issue: "建設業許可、物件参加資格、実績整理、物件探索の準備が必要です。",
    firstStep: "許可・資格・対応可能工種を確認し、参入できる発注先を絞ります。",
    action30Days: ["建設業許可と経審の必要性を確認する", "自治体と外郭団体の発注情報を調べる", "過去実績を公共向けの形式で整理する"],
    action90Days: ["物件参加資格の申請準備を進める", "少額物件や随意契約の入口を探す", "公共工事用の原価・書類管理を整える"]
  },
  D: {
    code: "D",
    name: "利益改善型",
    ...
    firstStep: "直近10件の物件ごとに売上、材料費、外注費、人工を確認します。",
    action30Days: ["赤字・低粗利物件の共通点を出す", "最低粗利率と受注しない条件を決める", "追加工事の請求ルールを作る"],
    action90Days: ["標準見積単価表を運用する", "物件別の粗利表を毎月更新する", "利益が残る顧客・工種へ営業を集中する"]
  },
  E: {
    code: "E",
    name: "集客強化型",
  ...
  F: {
    ...
    action30Days: ["現場・見積・請求の業務フローを整理する", "採用または外注化する業務を決める", "物件管理表を運用する"],
    action90Days: ["協力先と従業員の役割を明確にする", "月次の数字会議を始める", "売上目標から必要物件数と人員数を逆算する"]
  },
  G: {
    code: "G",
    name: "事業転換型",
    currentState: "今の受注構造や工種だけでは、目標売上や利益に届きにくい可能性があります。",
    issue: "伸ばす工種、やめる物件、狙う顧客層を見直す必要があります。",
    firstStep: "利益が残る工事と将来伸ばしたい事業領域を切り分けます。",
    action30Days: ["過去物件を工種別に売上・粗利で並べる", "撤退候補の仕事を決める", "新しく伸ばすサービスを1つ選ぶ"],
...
export const DIAGNOSIS_QUESTIONS: DiagnosisQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "unknown", label: "物件別には把握できていない", scores: { D: 3, G: 1 } }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { value: "public", label: "公共物件・物件", scores: { C: 3 } }
    ]
  },
  {
    key: "sales_activity",
  ...
  },
  {
    ...
    type: "radio",
    options: [
      { value: "per_project", label: "物件別に管理している", scores: { F: 1, C: 1 } },
