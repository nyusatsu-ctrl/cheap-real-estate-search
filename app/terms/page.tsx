...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      `有料プランの販売価格は${BUSINESS_INFO.monthlyPriceText}です。有料申込み時に即時決済され、以後毎月自動更新されます。支払方法は${BUSINESS_INFO.paymentMethod}です。`
    ]
  },
  {
    title: "第6条 解約",
    body: [
      "有料プランの解約、契約確認、カード変更は、会員画面からStripeの契約管理画面を開いて行えます。",
      "解約手続き完了後は次回更新分から課金を停止し、支払済み期間の終了日まで利用できます。既に発生した利用料金の日割り返金は、法令上必要な場合を除き行いません。"
    ]
  },
  {
    title: "第7条 禁止事項",
